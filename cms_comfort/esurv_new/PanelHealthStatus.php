                                    ...
                                    <div class="col-md-6 col-xl-3">
                                        <div class="card-box widget-flat border-success bg-success text-white" style="padding-bottom: 0px;">
                                           ...
                                           // echo "18/3 // 28/3";
                                            ...
                                            ?></h3>
                                            <p class="text-uppercase m-b-5 font-13 font-600"  >
											<a href="#" style="color:white">Conn</a> / <a href="#" style="color:white" >NotConn</a> // <a href="#" style="color:white">Conn</a> / <a href="#" style="color:white" >NotConn</a></p>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-box widget-flat border-success bg-success text-white" style="padding-bottom: 0px;">
                                           ...
                                           <?php 
                                            ...
                                            $fetchConnectQry=mysqli_fetch_array($Connectqry);
                                             ...
                                             if($_SESSION['permission']!="" && $_SESSION['designation']=="2"){$Q13.= $add;}
                                             if($_SESSION['designation']=="4"){$Q13.= $add;}
                                            ...
                                            $Q14="select count(*) as totalConnect from panel_health where status='0' and panelName ='smarti_boi' ";
                                             if($_SESSION['permission']!="" && $_SESSION['designation']=="2"){$Q14.= $add;}
											 if($_SESSION['designation']=="4"){$Q14.= $add;}
                                            ...
                                            $Q15="select count(*) as totalNotConnect from panel_health where status='1' and panelName ='smarti_boi'";
                                             if($_SESSION['permission']!="" && $_SESSION['designation']=="2"){$Q15.= $add;}
											 if($_SESSION['designation']=="4"){$Q15.= $add;}
											...
											$Q16="select count(*) as totalConnect from panel_health where status='0' and panelName ='smarti_pnb' ";
                                             if($_SESSION['permission']!="" && $_SESSION['designation']=="2"){$Q16.= $add;}
											 if($_SESSION['designation']=="4"){$Q16.= $add;}
                                            ...
                                            $Q17="select count(*) as totalNotConnect from panel_health where status='1' and panelName ='smarti_pnb'";
                                             if($_SESSION['permission']!="" && $_SESSION['designation']=="2"){$Q17.= $add;}
											 if($_SESSION['designation']=="4"){$Q17.= $add;}
										   ...
										   echo $fetchConnectQry['totalConnect'] . "/" .  $fetchNotConnectQry['totalNotConnect'] . " // " . $fetchConnectQry2['totalConnect'] . "/" .  $fetchNotConnectQry2['totalNotConnect']. " // " . $fetchConnectQry3['totalConnect'] . "/" .  $fetchNotConnectQry3['totalNotConnect'];
                                            ...
                                            ?></h3>
                                            <p class="text-uppercase m-b-5 font-13 font-600"  >
											<a href="#" style="color:white">Conn</a> / <a href="#" style="color:white">NotConn</a> // <a href="#" style="color:white">Conn</a> / <a href="#" style="color:white">NotConn</a>// <a href="#" style="color:white" >Conn</a> / <a href="#" style="color:white" >NotConn</a></p>
                                        </div>
                                    </div>
