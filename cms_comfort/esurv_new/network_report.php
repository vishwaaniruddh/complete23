                                    ...
                                    <div class="col-md-6 col-xl-3">
                                        <div class="card-box bg-primary widget-flat border-primary text-white" style="padding-left: 4px;padding-bottom: 0px;">
                                            ...
                                            <h3 class="m-b-10">
                                                ...
                                                <?php 
$dvrping_stmt = "SELECT a.ATMID as ATMID,a.bank as Bank,a.dvrip as DVRIP,b.dvr as DVR_datetime,a.routerip as RouterIp,b.router as router_datetime,a.panelip as PanelIP,b.panel as panel_datetime FROM `sites` a,network_report b WHERE a.sn=b.SN and a.live='Y'";												
if($_SESSION['designation']=="4"){
   $dvrping_stmt .= " and a.Customer='Hitachi'";
} 
$dvr_sql = mysqli_query($conn,$dvrping_stmt);
$total_rows = mysqli_num_rows($dvr_sql);
$today = date('Y-m-d');

$dvrping_stmt1 = "SELECT a.ATMID as ATMID,a.bank as Bank,a.dvrip as DVRIP,b.dvr as DVR_datetime,a.routerip as RouterIp,b.router as router_datetime,a.panelip as PanelIP,b.panel as panel_datetime FROM `sites` a,network_report b where a.sn=b.SN and a.live='Y' and b.dvr > '".$today."'";
if($_SESSION['designation']=="4"){
   $dvrping_stmt1 .= " and a.Customer='Hitachi'";
} 
$dvr_sql1 = mysqli_query($conn,$dvrping_stmt1);
                                    ...
                                    <div class="col-md-6 col-xl-3">
                                        <div class="card-box widget-flat border-success bg-success text-white" style="padding-bottom: 0px;">
                                            ...
                                            <h3 class="m-b-10">
                                                ...
                                                <?php
$routerping_stmt = "SELECT a.ATMID as ATMID,a.bank as Bank,a.dvrip as DVRIP,b.dvr as DVR_datetime,a.routerip as RouterIp,b.router as router_datetime,a.panelip as PanelIP,b.panel as panel_datetime FROM `sites` a,network_report b where a.sn=b.SN and a.live='Y' and b.router > '".$today."'";												
if($_SESSION['designation']=="4"){
   $routerping_stmt .= " and a.Customer='Hitachi'";
} 
$dvr_sql2 = mysqli_query($conn,$routerping_stmt);
...
<?php
$panelping_stmt = "SELECT a.ATMID as ATMID,a.bank as Bank,a.dvrip as DVRIP,b.dvr as DVR_datetime,a.routerip as RouterIp,b.router as router_datetime,a.panelip as PanelIP,b.panel as panel_datetime FROM `sites` a,network_report b where a.sn=b.SN and a.live='Y' and b.panel > '".$today."'";
if($_SESSION['designation']=="4"){
   $panelping_stmt .= " and a.Customer='Hitachi'";
} 
$dvr_sql3 = mysqli_query($conn,$panelping_stmt);
...
<div class="data" style="overflow: auto;">
  ...
  <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                          <?php 
$net_count = 1 ; 
                            $net_stmt = "SELECT a.DVRName as DVRName, a.ATMID as ATMID,a.SiteAddress as SiteAddress , a.City as city , a.State as State, a.Panel_Make as Panel_Make,a.bank as Bank,a.dvrip as DVRIP,b.dvr as DVR_datetime,a.routerip as RouterIp,b.router as router_datetime,a.panelip as PanelIP,b.panel as panel_datetime FROM `sites` a,network_report b WHERE a.sn=b.SN and a.live='Y'";
							if($_SESSION['designation']=="4"){
							   $net_stmt .= " and a.Customer='Hitachi'";
							} 
                            $net_sql = mysqli_query($conn,$net_stmt);
...
$panel_datetime = date('d-m-Y',$panel_datetime);
                                ...
                                ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo $net_sql_result['SiteAddress']; ?>
                                                
                                            </td>
                                            <td>
                                                <?php echo $net_sql_result['city']; ?>
                                                
                                            </td>
                                            <td>
                                                <?php echo $net_sql_result['State']; ?>
                                                
                                            </td>
                                            <td>
                                                <?php echo $net_sql_result['Panel_Make']; ?>
                                                
                                            </td>
                                            <td>
                                                <?php echo $net_sql_result['DVRName']; ?>
                                            </td>
