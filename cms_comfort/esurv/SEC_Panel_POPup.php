                        ...
                        <div class="card-box">
                            ...
                            <div class="text-center mt-4 mb-4">
                                <div class="row">
                                    ...
                                    <?php  if($value=="ConnSEC" || $value=="NotConnSEC"){  ?>
                                    <div class="col-md-6 col-xl-3">
                                        <div class="card-box bg-danger widget-flat border-danger text-white" style="padding-bottom: 0px;">
                                            ...
                                            <h></h> Securico</h>
                                            <h3 class="m-b-10"><?php $Connectqry=mysqli_query($conn,"select count(*) as totalConnect from panel_health where status='0' and panelName='SEC'");
                                            $fetchConnectQry=mysqli_fetch_array($Connectqry);
                                            
                                            $NotConnectqry=mysqli_query($conn,"select count(*) as totalNotConnect from panel_health where status='1' and panelName='SEC'");
...
<div align="center" style="display:none"><input type="text" id="Atmid" name="Atmid" placeholder="Search Atm-ID"  /><input type="button" value="search" onClick="a('','50')" /></div>
     ...
     <td ><div >ATM-ID</div></td>
      ...
      <td ><div >Date_Time&nbsp; </div></td>
        <td ><div style="" id="">Motion Sensor</div></td>
        ...
        <td><div id="">Chest door ATM1</div></td>
        <td><div id="">ATM2 Removal</div></td>
        <td><div id="">ATM 2 Vibration</div></td>
        <td><div id="">ATM 2 Thermal/ Heat</div></td>
        -->
        <td><div id="">Chest door ATM2</div></td>
        <td><div id="">ATM 1/2 Hood Door Sensor</div></td>
        <td><div id="">ATM 3 Removal</div></td>
        <td><div style="" id="">ATM 3 Vibration</div></td>
        <td><div style="" id="">ATM 3 Thermal/ Heat</div></td>
        <td><div id="">Chest door ATM3</div></td>
        ...
        <td><div style="" id="">Backroom door</div></td>
        <td><div id="">LobySetThermostrateSenHighTem(ylw+wht)</div></td>
        <td><div style="" id="">Tamper Switch</div></td>
        <td><div id="">LobySetThermoSenLowTem(Purple+Brw)</div></td>
        <td><div style="" id="">CCTV Removal</div></td>
        <td><div id="">Speaker / MIC Removal</div></td>
        <td><div id="">AC Mains (DI)</div></td>
        <td><div style=""  id="">UPS O/P (DI)</div></td>
 ...
 if($value=="ConnSEC" ){
 $qrys=mysqli_query($conn,"select * from panel_health where status='0' and panelName='SEC' ");
 }else if($value=="NotConnSEC"){
 $qrys=mysqli_query($conn,"select * from panel_health where status='1' and panelName='SEC' ");
 }
