                        ...
                        <div class="card-box">
                            ...
                            <div class="text-center mt-4 mb-4">
                                <div class="row">
                                    ...
                                    <?php  if($value=="ConnSmartiPNB" || $value=="NotConnSmartiPNB"){  ?>
                                    <div class="col-md-6 col-xl-3">
                                        <div class="card-box bg-danger widget-flat border-danger text-white" style="padding-bottom: 0px;">
                                            <i class="fi-delete" style="pointer-events: none; cursor: default;">Securico</i>
                                             <h>Smart-I PNB</h>
                                           <h3 class="m-b-10"><?php $Connectqry=mysqli_query($conn,"select count(*) as totalConnect from panel_health where status='0' and panelName ='smarti_pnb' ");
                                            $fetchConnectQry=mysqli_fetch_array($Connectqry);
                                            
                                            $NotConnectqry=mysqli_query($conn,"select count(*) as totalNotConnect from panel_health where status='1' and panelName ='smarti_pnb'");
                                            $fetchNotConnectQry=mysqli_fetch_array($NotConnectqry);
                                            
                                            echo $fetchConnectQry['totalConnect'] . "/" .  $fetchNotConnectQry['totalNotConnect'];
                                            ?></h3>
                                            <p class="text-uppercase m-b-5 font-13 font-600"  ><a href="Smarti_PNB_Panel_POPup.php?id=ConnSmartiPNB" style="color:white" target="_blank">Connected</a> / <a href="Smarti_PNB_Panel_POPup.php?id=NotConnSmartiPNB" style="color:white" target="_blank">Not Connected</a></p>
                                        </div>
                                    </div><?php } ?>
                                </div>
                            </div>
...
<div align="center" style="display:none"><input type="text" id="Atmid" name="Atmid" placeholder="Search Atm-ID"  /><input type="button" value="search" onClick="a('','50')" /></div>
 ...
 if($value=="ConnSmartiPNB" ){
 $qrys=mysqli_query($conn,"select * from panel_health where status='0' and panelName='smarti_pnb' ");
 }else if($value=="NotConnSmarti"){
 $qrys=mysqli_query($conn,"select * from panel_health where status='1' and panelName='smarti_pnb' ");
 }
