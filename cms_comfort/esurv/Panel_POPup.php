                        ...
                        <div class="card-box">
                            ...
                            <div class="text-center mt-4 mb-4">
                                <div class="row">
                                    ...
                                    <?php if ($value == "ConnRass" || $value == "NotConnRass") { ?>
                                        ...
                                        <div class="col-md-6 col-xl-3">
                                            <div class="card-box bg-primary widget-flat border-primary text-white"
                                                ...
                                                <h>RASS</h>
                                                <h3 class="m-b-10"><?php $Connectqry = mysqli_query($conn, "select count(*) as totalConnect from panel_health where status='0' and panelName='Rass'");
                                                $fetchConnectQry = mysqli_fetch_array($Connectqry);

                                                $NotConnectqry = mysqli_query($conn, "select count(*) as totalNotConnect from panel_health where status='1' and panelName='Rass'");
                                            ...
                                            <div class="col-md-6 col-xl-3">
                                                <div class="card-box widget-flat border-success bg-success text-white"
                                                    style="padding-bottom: 0px;">
                                                    <i class="fi-help" style="pointer-events: none; cursor: default;">Smart-I</i>
                                                    <h>Smart-I</h>
...
<th>Relay 10</th>
                                ...
                                <tbody>
                                    ...
                                    if ($value == "ConnRass") {
                                        $qrys = mysqli_query($conn, "select * from panel_health where status='0' and panelName='Rass' ");
                                    } else if ($value == "NotConnRass") {
                                        $qrys = mysqli_query($conn, "select * from panel_health where status='1' and panelName='Rass' ");
                                    }
                                    /*else if($value=="error"){
