...
<body onload="a('','','dvrhealth_process_detail_test_new.php')">
...
$add=" and atmid IN (select ATMID from sites where Customer='Hitachi' and live='Y')";
                            ...
                            $Q1="select count(*) as totalDVR from all_dvr_live where live='Y'";
                            ...
                            <h3 class="m-b-10"><?php 
                            $Q2="select count(*) as totalConnect from all_dvr_live where status='1' and login_status='0' and live='Y'";
                            ...
                            $Q3="select count(*) as totalNotConnect from all_dvr_live where (`status`='1' or status IS NULL) and login_status='1' and live='Y'";
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="card-box bg-primary widget-flat border-primary text-white" style="padding-left: 4px;padding-bottom: 0px;">
                            ...
                            <h>HDD Not Working</h> 
                            <h3 class="m-b-10"><?php 
                            $Q4="select count(*) as totalError from all_dvr_live where hdd='error'";
                            ...
                            $Q5="select count(*) as totalNotExist from all_dvr_live where hdd='notexist' or hdd='Not Exist' ";
                            ...
                            $fetchNotExistQry=mysqli_fetch_array($notexistqry);
                              ...
                              $Q6="select count(*) as totalSmartFailed from all_dvr_live where hdd='smartFailed' ";
                            ...
                            $fetchsmartFailedQry=mysqli_fetch_array($smartFailedqry);
							 ...
							 $Q61="select count(*) as totalAbNormal from all_dvr_live where hdd='abnormal' ";
                            ...
                            $fetchabNormalQry=mysqli_fetch_array($abnormalqry);
							 ...
							 $Q62="select count(*) as totalNoDisk from all_dvr_live where hdd='No Disk' or hdd='No disk/idle' ";
                            ...
                            $Q7="select count(*) as totalUnformatted from all_dvr_live where hdd='unformatted' ";
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="card-box widget-flat border-success bg-success text-white" style="padding-bottom: 0px;">
                            ...
                            $Q8="select count(*) as totalDVR from all_dvr_live where status='1' and login_status='1'  and live='y' ";
                            if($_SESSION['permission']!="" && $_SESSION['designation']=="2"){$Q8.= $add;}
							if($_SESSION['designation']=="4"){$Q8.= $add;}
                            $qrydvr=mysqli_query($conn,$Q8);
                            $fetchDvrQry=mysqli_fetch_array($qrydvr);
							$dvr_his = "select id from dvr_history where CAST(last_communication AS DATE)='".$today."' AND login_status='0' AND atmid IN (SELECT atmid FROM `all_dvr_live` WHERE status='1' AND  login_status='1' AND live='y') GROUP BY atmid";
                        ...
                        <div class="card-box bg-danger widget-flat border-danger text-white" style="padding-bottom: 0px;">
                            ...
                            <h3 class="m-b-10 text-left">
                                ...
                                $cam1_notworking_sql = mysqli_query($conn,"
                                    SELECT count(1) as total_cam1_not FROM `all_dvr_live` where DATE(last_communication)<> '".$today."' and cam1='not working'");
                                ...
                                $cam1working_sql = mysqli_query($conn,"SELECT count(1) as total_cam1 FROM `all_dvr_live` where DATE(last_communication)= '".$today."' and cam1='working'") ; 
                            ...
                            <h3 class="m-b-10 text-left">
                                ...
                                $cam2_notworking_sql = mysqli_query($conn,"
                                    SELECT count(1) as total_cam2_not FROM `all_dvr_live` where DATE(last_communication)<> '".$today."' and cam2='not working'");
                                ...
                                $cam2working_sql = mysqli_query($conn,"SELECT count(1) as total_cam2 FROM `all_dvr_live` where DATE(last_communication)= '".$today."' and cam2='working'") ; 
                            ...
                            <h3 class="m-b-10 text-left">
                                ...
                                $cam3_notworking_sql = mysqli_query($conn,"
                                    SELECT count(1) as total_cam3_not FROM `all_dvr_live` where DATE(last_communication)<> '".$today."' and cam3='not working'");
                                ...
                                $cam3working_sql = mysqli_query($conn,"SELECT count(1) as total_cam3 FROM `all_dvr_live` where DATE(last_communication)= '".$today."' and cam3='working'") ; 
                            ...
                            <h3 class="m-b-10 text-left">
                                ...
                                $cam4_notworking_sql = mysqli_query($conn,"
                                    SELECT count(1) as total_cam4_not FROM `all_dvr_live` where DATE(last_communication)<> '".$today."' and cam4='not working'");
                                ...
                                $cam4working_sql = mysqli_query($conn,"SELECT count(1) as total_cam4 FROM `all_dvr_live` where DATE(last_communication)= '".$today."' and cam4='working'") ; 
