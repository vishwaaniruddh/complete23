                        ...
                        <ul class="list-unstyled topbar-right-menu float-right mb-0">
                            ...
                            <li class="dropdown notification-list">
                                <a class="nav-link dropdown-toggle waves-effect nav-user" data-toggle="dropdown" href="#" role="button"
                                   aria-haspopup="false" aria-expanded="false">
                                     <input type="button" class="rounded-circle"  value="<?php echo strtoupper(substr($_SESSION['name'], 0, 1));?>"> <span class="ml-1 pro-user-name"><?php echo strtoupper($_SESSION['name']);?><i class="mdi mdi-chevron-down"></i> </span>
                                </a>
...
<?php if($_SESSION['designation']!="2"){ if($_SESSION['designation']!="4"){ ?>
...
<?php } }?>
                            <li class="has-submenu">
                                <a href="#"><i class="icon-layers"></i>Health Report</a>
                                <ul class="submenu">
                                    <li><a href="PanelHealthStatus.php">Panel Health</a></li>
                                    <li><a href="DVRHealthStatus.php">DVR Health</a></li>
									<?php if($_SESSION['designation']!="4"){ ?>
                                    <li><a href="axisDVRHealthStatus.php">Axis DVR Health</a></li>
                                    <?php } ?>
                                </ul>
                            </li>

                            <li class="has-submenu">
                                <a href="network_report.php"><i class="icon-speedometer"></i>Network Report</a>
                            </li>
