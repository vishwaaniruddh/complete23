...
const CameraThree = () => {
    ...
    const exportToExcel = () => {
        ...
        const fileName = 'Cam3_NotWorkingReport';
    ...
    useEffect(() => {
        axios.get(`${process.env.REACT_APP_DVRHEALTH_API_URL}/cam3_not_working`)
            .then(response => {
                ...
                <div>
                    <div className="row">
                        <div className="col-6 pt-2">
                            <h6>Camera Three Not Working</h6>
                                ...
                                currentPost.map((users, index) => {
                                    return (
                                        <tr key={index}>
                                            ...
                                            <td style={{ color: 'red', fontWeight: 'bold', fontSize: '13px' }}>{users.cam3}</td>
                                            <td>
