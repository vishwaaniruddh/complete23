...
$bank = "PNB"; 
$sql_qry = "select ATMID,SN,SiteAddress,DVRIP,PanelIP,RouterIp,ATMID_2,ATMID_3,live_date,Zone,State from sites where Customer='" . $client . "' and Bank='" . $bank . "' and live='Y' AND SN IN (SELECT SN from `newnetwork_report` WHERE month_date='".$mon_date."' AND month='".$month."' AND year='".$year."' AND is_update=0)";
