...
/*	 
    ...
    if (empty($_SERVER['HTTPS']) || $_SERVER['HTTPS'] === "off") {
		//echo $_SERVER['HTTP_HOST'].'==';echo $_SERVER['REQUEST_URI'];die;
		$http_host = $_SERVER['HTTP_HOST'];
		$http_host_split = explode(":",$http_host);
		$http_host_url = $http_host_split[0];
		
		$location = 'https://' . $http_host_url . $_SERVER['REQUEST_URI'];
...
$title = "Comfort Techno Services, Ltd. - ".$_SESSION['username'];
?>
<head>
        <!-- Required meta tags -->
        <meta charset="utf-8">
                        ...
                        <link href="vendors/css/vendor.bundle.addons.css" rel="stylesheet">
                            ...
                            <link href="css/style.css" rel="stylesheet">
                               ...
                               <!-- <link rel="shortcut icon" href="images/favicon.png"> -->
								<link rel="shortcut icon" href="media/comfortnewlogo.jpg">
                            </link>
                        </link>
                    </link>
                </link>
