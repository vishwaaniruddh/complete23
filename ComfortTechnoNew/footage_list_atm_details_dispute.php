...
.tooltip:hover .tooltiptext {
  visibility: visible;
         ...
         <?php include('top-navbar.php');
				...
				$getimagesql = "SELECT * FROM `footage_details_available` WHERE month='".$mon."' AND dt='".$dt."' AND footage_type='Dispute'"; 
				//echo $getimagesql;
				...
				$getstatussql = "SELECT * FROM `footage_details_available_status` WHERE month='".$mon."' AND dt='".$dt."' AND footage_type='Dispute'"; 
				//echo $getimagesql;
				$getstatusdata = mysqli_query($con,$getstatussql);
				$checkstatus_arr = array();
				//echo mysqli_num_rows($getimagesdata);die;
				if(mysqli_num_rows($getstatusdata)>0){
					while($foot_data = mysqli_fetch_assoc($getstatusdata)){
						$fol_atmid = $foot_data['atmid'];
						$seq = $mon."_".$dt."_".$fol_atmid;
						array_push($checkstatus_arr,$seq);
					}
				}
                ...
                $folder_path = "Footage_Upload/Dispute/".$atmpath; 				
            ...
            <div class="container-fluid page-body-wrapper">
                ...
                <div class="main-panel">
                    <div class="content-wrapper">
						  ...
						  <div class="card">
							<div class="card-body">
							  <h4 class="card-title">Footage Dispute Details > <?php echo $mon; ?> > <?php echo $dt; ?></h4>
								 ...
								 <div class="row">
								    <?php if(count($file_list)>0){ 
									          for($i=0;$i<count($file_list);$i++){
												  ...
												  if(count($split_atm)==5){
													 ...
													 if(in_array($full_fol_path,$checkstatus_arr)){
														 $foot_empty = 1;
													 }
									...
									<div class="col-lg-3 col-xl-2" style="border: 1px solid;padding:8px;">
										<a href="footage_list_atm_image_details_dispute.php?atmimage=<?php echo $_atmimage;?>" title="Click ME">  
       ...
       <script>
		...
		function get_Detail(atmid,atm){ 
				...
				$("#load").show();
				$.ajax({
							url: "footage_atm_list_zip_dispute.php", 
							type: "POST",
