	...
	<style>
		...
		th, td {
         ...
         <?php include('top-navbar.php');
				...
				$getimagesql = "SELECT * FROM `footage_details_available` WHERE month='".$mon."' AND dt='".$dt."'"; 
				//echo $getimagesql;
                ...
                $folder_path = "Footage_Upload/".$atmpath; 				
            ...
            <div class="container-fluid page-body-wrapper">
                ...
                <div class="main-panel">
                    <div class="content-wrapper">
						  ...
						  <div class="card">
							<div class="card-body">
							  <h4 class="card-title">Footage Details</h4>
								 ...
								 <div class="row">
								    <?php if(count($file_list)>0){ 
									          for($i=0;$i<count($file_list);$i++){
												  ...
												  if(count($split_atm)==4){
													   $foot_id = 0;
													 $_fol_month = $split_atm[1];
													 $_fol_dat = $split_atm[2];
									...
									<div class="col-lg-3 col-xl-2">
										<a href="footage_list_atm_image_details.php?atmimage=<?php echo $_atmimage;?>" title="Click ME">  
                                        ...
                                        <div class="row">										
											<div class="col-md-6 col-xl-6">
											    <a class="btn btn-danger" id="<?php echo $_atmid_val;?>" style="display:none;" href="<?php echo $path;?>" download><i class="fa fa-download"></i></a>
											</div>
                                        </div>	
                                        <?php }else{ ?>	
                                         <div class="row">										
											<div class="col-md-6 col-xl-6">
											   <a class="btn btn-danger" href="<?php echo $path;?>" download><i class="fa fa-download"></i></a>
											</div>
											<div class="col-md-6 col-xl-6">
											<!-- <a  href="<?php echo $path;?>" download> -->
											    <button class="btn btn-info" onclick="myFunction('<?php echo 'https://103.141.218.26/ComfortTechnoNew/download_footage.php?path='.$path;?>')"><i class="fa fa-copy"></i></button>
											</div>
                                        </div>	 
                                        <?php } ?>										
									</div>
       ...
       <script>
		 ...
		 function get_Detail(atmid,atm){ 
				...
				$("#load").show();
				$.ajax({
							url: "footage_atm_list_zip_test - Copy.php", 
							type: "POST",
