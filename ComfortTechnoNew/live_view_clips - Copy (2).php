...
<h3 class="card-title">Live View</h3>
    ...
    <video id="myvideo" width="400" height="300" controls muted autoplay loop playsinline>
	  <source src="test/172.55.24.223_1_1.mp4" type="video/mp4">
					            ...
					            <div class="row">
                                    ...
                                    <div class="sortblock col-md-5 form-group">
										...
										<div class="card form-group">
                                            ...
                                            <div class="card-body" id="camera1" style="height: 200px;padding-top:0px;">
                                    ...
                                    <div class="sortblock col-md-5 form-group">
										...
										<div class="card">
                                            ...
                                            <div class="card-body" id="camera2" style="height:200px;padding-top:0px;">
								...
								<div class="row">
                                    ...
                                    <div class="sortblock col-md-5 form-group">
										...
										<div class="card form-group">
                                            ...
                                            <div class="card-body" id="camera3" style="height:200px;padding-top:0px;">
                                    ...
                                    <div class="sortblock col-md-5 form-group">
										...
										<div class="card">
                                            ...
                                            <div class="card-body" id="camera4" style="height:200px;padding-top:0px;">
	...
	function play_video() {
		...
		$.ajax({
			...
			success: (function (result) { 
			   var objCode = result.code;
			   if(objCode==200){
				   video_array.push(result.path);
				   var key = result.n - 1;
				   changeVid(key);
			   }else{
		...
		function set_Camera(atmid){
			...
			$.ajax({
				...
				success: (function (result) { debugger;
					...
					$("#camera1").html('<iframe src="'+ new_cam + '" title="description" style="height: 33vh;width: 100%" scrolling="no"></iframe>');
					play_video();
