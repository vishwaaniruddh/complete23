							   ...
							   <tr>
									...
									<?php }else{ 
									    if($sql_result['is_available']==0){
									        ...
									        echo 'No';?></br>
											<a target="_blank" href="footage_request_no_video_update.php?id=<?php echo $foot_id;?>">Update Not Available</a></br>
											<a target="_blank" href="footage_request_manual_upload.php?id=<?php echo $foot_id;?>&atmid=<?php echo $_atmid;?>">Upload Video</a></br>
									<?php } } ?>		
									</td>	
