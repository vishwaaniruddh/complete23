...
<div class="table-responsive">
                  ...
                  <td><?php if($router_status_online==0){ echo 'Offline';}else{ echo 'Online';}?></td>
				  <td><?php echo $routerip;?></td>
				  <td><?php echo $routerlast_communication;?></td>
				  <td><?php echo $routeronlinepercent;?></td>
                  <td><?php if($dvr_status_online==0){ echo 'Offline';}else{ echo 'Online';}?></td>
                  <td><?php echo $dvrip;;?></td>
				  <td><?php echo $dvrlast_communication;?></td>
				  <td><?php echo $dvronlinepercent;?></td>
                  <td><?php if($panel_status_online==0){ echo 'Offline';}else{ echo 'Online';}?></td>
