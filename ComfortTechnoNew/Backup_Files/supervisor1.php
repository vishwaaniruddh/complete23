<!DOCTYPE html>
					...
					<div class="card">
                    <div class="card-body">
                    <h4 class="card-title" style="color:#fff;">UserWise Count-Total Served Tickets:<input type="number"></h4>
                    ...
                    <div class="col-md-6 grid-margin stretch-card">
							...
							<?php include("filters/supervisorscreen_filter.php")?>
                                <h4 class="card-title" style="color:#fff;">Top 5 Tickets which took more than 3 Mins Time:<input type="time"></h4>
					...
					<div class="card">
                    <div class="card-body">
                    <h4 class="card-title" style="color:#fff;">ClientWise Ticket Count</h4>
