											...
											if($atmid){
											    ...
											    if(mysqli_num_rows($sql)>0){ 
													...
													if($timeoftxn!='' && $start_time!='' && $end_time!='' && $dateoftxn!=''){
														$statement = " INSERT INTO `footage_request_logic`( `atmid`, `card_no`, `date_of_TXN`, `time_of_TXN`, `start_time`, `end_time`, `nature_of_TXN`, `amount_of_TXN`, `txn_no`, `complaint_no`, `complaint_date`, `claim_date`) VALUES ('".$atmid."','".$cardno."','".$dateoftxn."','".$timeoftxn."', '".$start_time."', '".$end_time."','".$natureoftxn."','".$amountoftxn."','".$txnnumber."','".$complaint_no."','".$complaint_date."','".$claim_date."') ";
														//echo $statement;die;
