...
?>
<div class="card">
	<div class="card-header" id="heading-<?php echo $panelid;?>" role="tab" onclick="setATMID('<?php echo $panelid;?>','<?php echo $_atmid;?>','<?php echo $sensorname;?>');">
		<h6 class="mb-0">
			<a aria-controls="collapse-<?php echo $panelid;?>" aria-expanded="false" class="collapsed" data-toggle="collapse" href="#collapse-<?php echo $panelid;?>">
				<span ><?php echo "1. ".$sites_sql_result['ATMID']." - ".$sensorname; ?></span>
			</a>
		</h6>
	</div>
