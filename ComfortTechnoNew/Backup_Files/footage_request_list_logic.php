...
<html lang="en">
	...
	<style>
		...
		#footagerequest_download{display:none;}
	</style>
                    ...
                    <div class="content-wrapper">
						  ...
						  <div class="card">
							<div class="card-body">
							  ...
							  <div class="row">
							    <div class="col-12" id="footagerequest_download">
								<a style="margin-bottom:10px;" class="btn btn-success" href="footage_request_download_excel_report.php">MULTIPLE FOOTAGE REQUEST</a>
								</div>
        ...
        <script src="js/footagerequest_logic.js"></script>
