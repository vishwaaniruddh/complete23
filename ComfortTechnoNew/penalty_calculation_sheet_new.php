...
<html lang="en">
    <?php   
	        $page_title = "Penalty Calculation Sheet Report (".date('d-m-Y').")";
	        include('head.php');
                ...
                <div class="main-panel">
                    <div class="content-wrapper">
					    ...
					    <div class="col-12 grid-margin">
                         <h6 class="card-title">Penalty Calculation Report</h6> 
                          <?php include('filters/penalty_calculation_sheet_filter.php');?>
						</div> 
                        <!-- Dashboard Wighets -->
...
<!-- Modal starts -->
        ...
        <script src="js/penalty_calculation_sheet_new.js"></script>
