...
$code = 201;
$atmimagepath = "May/2023_05_27/N8303100 03-05-2023 15.54 to 16.04.mp4";
if($atmimagepath!=''){
	    date_default_timezone_set("Asia/Calcutta"); 
                $current_datetime = date('Y-m-d H:i:s');
				$con = OpenCon();
        $atm_val = "N8303100 03-05-2023 15.54 to 16.04.mp4";
       // $atmimagepath = $_POST['atmid'];
		...
		$ftp_pasv_local = ftp_pasv($ftp_conn_local,true);
         ...
         $newfolder_path = "Footage_Upload/Dispute/".$atmimagepath; 		
		//$newfolder_path = "Footage_Upload/Dispute/May/2023_05_27";													
		...
		if(count($newfile_list)>0){ 
			...
			for($i=0;$i<count($newfile_list);$i++){
				...
				if(count($split_atm_image)==5){
					...
					if($_atmid_imageval!="desktop.ini"){
                        $local_file_dir = "E:/Footage/Dispute/".$atmimagepath;
