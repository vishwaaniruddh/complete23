						...
						if(mysqli_num_rows($check_footage_res)==0){
							...
							if(count($finalfile_list)>0){ 
								...
								if(count($imagesdata_array)>0){
									...
									$set_sql = "INSERT INTO `footage_details_available_start_zip`( `month`, `dt`,`atmid`, `created_at`, `updated_at`, `created_by`, `footage_type`) VALUES ('".$mon."','".$dt."','".$_atmid_imageval."','".$current_datetime."','".$current_datetime."','24','".$footage_type."') ";
