...
.tooltip:hover .tooltiptext {
  visibility: visible;
         ...
         <?php include('top-navbar.php');
				...
				$getimagesql = "SELECT * FROM `footage_all_details_available` WHERE month='".$mon."' AND dt='".$dt."'"; 
				//echo $getimagesql;
                ...
                $folder_path = "All_Footages/".$atmpath; 				
            ...
            <div class="container-fluid page-body-wrapper">
                ...
                <div class="main-panel">
                    <div class="content-wrapper">
						  ...
						  <div class="card">
							<div class="card-body">
							  <h4 class="card-title">Footage Details > <?php echo $mon; ?> > <?php echo $dt; ?></h4>
								 ...
								 <div class="row">
									...
									<div class="col-lg-3 col-xl-2">
										<a href="footage_list_atm_image_details_ob.php?atmimage=<?php echo $_atmimage;?>" title="Click ME">  
       ...
       <script>
		...
		function get_Detail(atmid,atm){ 
				...
				$("#load").show();
				$.ajax({
							url: "footage_atm_list_zip_ob.php", 
							type: "POST",
