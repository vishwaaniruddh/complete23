...
if(mysqli_num_rows($sql)){
	while($sql_result = mysqli_fetch_assoc($sql)){
		...
		/*
		$dvrhealthsql = mysqli_query($con,"select login_status from dvr_health where atmid ='".$_atm_id."'"); 
		if(mysqli_num_rows($dvrhealthsql)>0){
			$dvrhealthsql_result = mysqli_fetch_assoc($dvrhealthsql);
		    $login_status = $dvrhealthsql_result['login_status'];
