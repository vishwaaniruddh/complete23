...
if(count($res_data)>0){
	$array = array(['Code'=>200,'res_data'=>$res_data,'camera_working_count'=>$camera_working_count,'camera_notworking_count'=>$camera_notworking_count,'total_site'=>$dvr_online_count]);
}else{
