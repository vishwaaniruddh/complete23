									...
									<div class="col-lg-3 col-xl-2" style="border: 1px solid;padding:8px;">
                                        ...
                                        <?php } }else{ ?>	
                                         <div class="row">										
											...
											<!--  <input type="text" id="urlToCopy" value="<?php echo 'https://103.141.218.26:8080/Hitachi/download_footage.php?path='.$path;?>" readonly>
                                              <button class="btn btn-info" id="copyButton" title="Click To Copy Download URL"><i class="fa fa-copy"></i></button> -->
											
											   <!-- <button class="btn btn-info" onclick="myFunction('<?php echo 'https://103.141.218.26:8080/Hitachi/download_footage.php?path='.$path;?>')" title="Click To Copy Download URL"><i class="fa fa-copy"></i></button> -->
											</div>
                                        </div>	 
                                        <?php } ?>										
									</div>
