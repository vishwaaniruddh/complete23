...
<div class="table-responsive">
                    <table id="order-listing" class="table">
                      ...
                      while($sql_result=mysqli_fetch_assoc($sql)) {
						...
						if($_view == 1){
						$atmcircle = mysqli_query($con,"select Circle from site_circle where ATMID='".$atm_id."'");
						$atm_circle_name = "";
						if(mysqli_num_rows($atmcircle)){
						$atmcircledata = mysqli_fetch_assoc($atmcircle);
						$atm_circle_name = $atmcircledata['Circle'];
						}
                      ...
                      ?>
                            <tr>
								...
								<td><?php echo $atm_circle_name;?></td>
