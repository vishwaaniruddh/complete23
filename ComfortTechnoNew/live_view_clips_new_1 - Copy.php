                                    ...
                                    <div class="sortblock col-md-6 form-group">
										...
										<div class="card form-group">
                                            ...
                                            <div class="card-body" id="camera1" style="height: 300px;padding-top:0px;">
											   <!-- <video id="myvideo" width="100%" height="300" controls muted autoplay loop playsinline>
...
var activeVideo = 0;
  ...
  var vidElement = document.getElementById('myvideo');
    ...
    var activeVideo = Math.floor((Math.random() * video_array.length));
    
    vidElement.addEventListener('ended', function(e) {
      
      activeVideo = (activeVideo) % video_array.length;
      if(activeVideo === video_array.length){
        activeVideo = 0;
      }

      
      vidElement.src = video_array[activeVideo];
      vidElement.play();
    });
   */
  ...
  "test/172.55.24.223_1_7.mp4","test/172.55.24.223_1_8.mp4","test/172.55.24.223_1_9.mp4","test/172.55.24.223_1_10.mp4","test/172.55.24.223_1_11.mp4","test/172.55.24.223_1_12.mp4"
	...
	if(activeVideo<=12){
    vidElement.addEventListener('ended', function(e) { debugger;
      // update the active video index
      activeVideo = (++activeVideo) % vidSources.length;
      if(activeVideo >= vidSources.length){
        //activeVideo = 0;
		vidSources.splice(0, vidSources.length);
      }else{
		  vidElement.src = vidSources[activeVideo];
          vidElement.play();
	  }
			...
			$.ajax({
				...
				success: (function (result) { debugger;
					...
					var interval = setInterval(function(){
						if(new Date().getTime() - startTime > 7200000){
