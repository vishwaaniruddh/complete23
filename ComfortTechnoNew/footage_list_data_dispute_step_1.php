							  ...
							  <h4 class="card-title">Footage Dispute Details</h4>
								 ...
								 <div class="row">
									...
									<div class="col-lg-3 col-xl-2">
										<a href="footage_list_data_dispute_step_2.php?month=<?php echo $_year.'/'.$_month_val;?>" title="Click ME">  
											...
											<?php if(!in_array($mon,$month_array_data)){ ?>	
													<div class="col-lg-3 col-xl-2">
														<a href="footage_list_data_dispute_step_2.php?month=<?php echo $_year.'/'.$mon;?>" title="Click ME">  
															<div class="file-man-box">
																<div class="file-img-box">
																	<img src="images/shared-folder.png">
																</div>
