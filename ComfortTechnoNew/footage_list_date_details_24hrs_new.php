	...
	<style>
		...
		th, td {
         ...
         <?php include('top-navbar.php');
				...
				$month = $_GET['month'];	
                $folder_path = "Footage_Upload/24Hrs/".$month; 				
            ...
            <div class="container-fluid page-body-wrapper">
                ...
                <div class="main-panel">
                    <div class="content-wrapper">
						  ...
						  <div class="card">
							<div class="card-body">
							  <h4 class="card-title">Footage 24Hrs Details > <?php echo $month;?> </h4>
								 ...
								 <div class="row">
									...
									<div class="col-lg-3 col-xl-2">
										<a href="footage_list_atm_details_24hrs_new.php?atmpath=<?php echo $month_atm;?>" title="Click ME">  
