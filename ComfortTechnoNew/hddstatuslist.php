    ...
    <div class="main-panel">
        <div class="content-wrapper">
            <div class="col-12 grid-margin">
                <h6 class="card-title">HDD Status - <?php echo $Client;?></h6>
            ...
            <div class="row form-group">
                ...
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">HDD <?php echo $sitestatus; ?></h4>
			...
			<script>
				...
				$(document).on("click", ".large-modal", function () { debugger;
					 var Id = $(this).data('id');
					  $.ajax({    
						type: "GET",
						url: "hdd_call_log_ticket_history_details.php?id="+Id,             
				...
				$('#smallModal form').on('submit', function (e) {
				  ...
				  $.ajax({
					type: 'post',
					url: 'process_hdd_call_log_action.php',
