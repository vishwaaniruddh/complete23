								...
								<div class="col-12">
								  <div class="table-responsive">
									<table id="order-listing" class="table">
									  <thead>
										<tr>
											<th>Created Date</th><th>Created By</th><th>Close Date</th>
									  ...
									  ?>
										<tr>
											...
											<td><?php if($ticket_status=='Active'){ echo $created_name; }?></td>
											<td><?php echo $sql_result['close_date'];?></td>
											<td><?php if($ticket_status=='Close'){ echo $created_name; }?></td>
