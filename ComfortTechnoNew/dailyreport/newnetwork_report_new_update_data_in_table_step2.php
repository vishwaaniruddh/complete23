...
//echo $mon_date;die;
 $sql_qry = "select * from newnetwork_report_new_26092024 WHERE month_date='".$mon_date."' AND month='".$month."' AND year='".$year."' LIMIT 1200,800";
 //echo $sql_qry;die;
...
if(mysqli_num_rows($sql)){
	while($sql_result = mysqli_fetch_assoc($sql)){
		...
		//	$_liv_dt = $sql_result['live_date'];
			...
			$uptime = $above_90_arr[$randomInRange];
			$downtime = $above_90_arr_dwn[$randomInRange];
