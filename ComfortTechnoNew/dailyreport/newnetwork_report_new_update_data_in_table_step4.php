...
//echo $mon_date;die;
 $sql_qry = "select * from newnetwork_report_new_26092024 WHERE month_date='".$mon_date."' AND month='".$month."' AND year='".$year."' AND SN IN (".$SNarray.")";
 //echo $sql_qry;die;
...
if(mysqli_num_rows($sql)){
	while($sql_result = mysqli_fetch_assoc($sql)){
		...
		//	$_liv_dt = $sql_result['live_date'];
			...
			$update_sql = "UPDATE `newnetwork_report_new_26092024` SET uptime='".$uptime."', downtime='".$downtime."', updated_at='".$created_at."' WHERE SN='".$SN."' AND month_date='".$mon_date."' AND month='".$month."' AND year='".$year."'";
			//echo 
