	...
	while($sql_result = mysqli_fetch_assoc($sql)){
		...
		if($_view==1){
		     if($panellast_communication=='0000-00-00 00:00:00'){
				 $panellast_communication = $start_date_time." 14:16:00";
			 }
		?>
	            <tr>
				  <td><?php echo $site_address;?></td><td><?php echo $atm_id;?></td>
				  <td class="pr-0 text-right"><div class="badge badge-pill <?php if($panelstatus==0){ echo 'badge-success';}else{ echo 'badge-danger';}?>"><?php echo $panellast_communication;?></div></td>
