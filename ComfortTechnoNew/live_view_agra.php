...
<html lang="en">
   ...
   ?>
	...
	<style>
		...
		#camera1 { width: 360px !important;
                   height: 265px;padding-left:0px !important;padding-right:0px !important;}
		#camera2 { width: 360px !important;
                   height: 265px;padding-left:0px !important;padding-right:0px !important;}
		...
		#camera1 iframe{ width: 360px !important;
    height: 265px !important;padding-left:0px !important;padding-right:0px !important;}
		#camera2 iframe{ width: 360px !important;
    height: 265px !important;padding-left:0px !important;padding-right:0px !important;}
		#camera3 iframe{ width: 360px !important;
    height: 265px !important;padding-left:0px !important;padding-right:0px !important;}
		#camera4 iframe{ width: 360px !important;
    height: 265px !important;padding-left:0px !important;padding-right:0px !important;}
		
		#camera1 iframe img{ width: 360px !important;
    height: 265px !important;}
		#camera2 iframe img{ width: 360px !important;
    height: 265px !important;}
    ...
    .loader_gif { 
	    background: url('images/newloading4.gif') no-repeat center center;
		position: absolute;
		top: 0.3em;
		left: 0;
		height: 100%;
...
<h3 class="card-title">Live View</h3>
              <div class="card">
                <div class="card-body">
                    ...
                    <?php include('filters/liveviewagra_filter.php');?>
					
					       <h6 style="color:red;">Please note: Click Refresh Button manually after watching any site live view <button class="btn btn-primary" id="show_detail"><a href="live_view_agra.php">Refresh</a>	</button></h6> 
								   ...
								   <!-- <div class="sortblock col-md-1 form-group"></div>  -->
                                    <div class="sortblock col-md-6 form-group">
										...
										<div class="card form-group">
                                            ...
                                            <div class="card-body" style="height: 265px;padding-top:0px;">
											   <!--<div id="loader_1" class="loader_gif" style="display:none;"></div>-->
												<div id="camera1"> <iframe id="iframe1" name="1" class="frame" src=""></iframe> </div>
                                    ...
                                    <div class="sortblock col-md-6 form-group">
										...
										<div class="card">
                                            ...
                                            <div class="card-body" style="height:265px;padding-top:0px;">
											  <!--<div id="loader_2" class="loader_gif" style="display:none;"></div>-->
												<div id="camera2"><iframe id="iframe2" name="2" class="frame" src=""></iframe> </div>
								...
								<div class="row">
                                    ...
                                    <div class="sortblock col-md-6 form-group">
										...
										<div class="card form-group">
                                            ...
                                            <div class="card-body" style="height:265px;padding-top:0px;">
												...
												<div id="camera3"> <iframe id="iframe3" name="3" class="frame" src=""></iframe></div>
                                            </div>
                                        </div>
                                    </div>
									<!-- <div class="sortblock col-md-1 form-group"></div> -->
                                    <div class="sortblock col-md-6 form-group">
										...
										<div class="card">
                                            ...
                                            <div class="card-body" style="height:265px;padding-top:0px;">
											  <!--<div id="loader_4" class="loader_gif" style="display:none;"></div>-->
												<div id="camera4"><iframe id="iframe4" name="4" class="frame" src=""></iframe> </div>
                                            </div>
                                        </div>
                                    </div>
		...
		<script src="js/live_view_agra_client_bank_circle_atmid.js"></script>
	...
	function setIframe(iframesrc){
		//var iframesrc = "http://103.141.218.26:5026/?name=admin-css12345-172.55.29.124-554-Hikvision_Nvr-nvr-1";
		$.ajax({
				url: "live_view_iframe1.php", 
				type: "GET",
				data: {url:iframesrc},
				dataType: "html", 
	...
	function setIframe2(iframesrc2){
		var iframesrc = "http://103.141.218.26:5027/?name=admin-css12345-172.55.29.124-554-Hikvision_Nvr-nvr-2";
		$.ajax({
				url: "live_view_iframe2.php", 
				type: "GET",
				data: {url:iframesrc2},
				dataType: "html", 
				success: (function (result) { 
	...
	function setIframe3(iframesrc3){
		var iframesrc = "http://103.141.218.26:5028/?name=admin-css12345-172.55.29.124-554-Hikvision_Nvr-nvr-3";
		$.ajax({
				url: "live_view_iframe3.php", 
				type: "GET",
				data: {url:iframesrc3},
				dataType: "html", 
				success: (function (result) { 
	...
	function setIframe4(iframesrc4){
		//var iframesrc = "http://103.141.218.26:5029/?name=admin-css12345-172.55.29.124-554-Hikvision_Nvr-nvr-4";
		$.ajax({
				url: "live_view_iframe4.php", 
				type: "GET",
				data: {url:iframesrc4},
				dataType: "html", 
				success: (function (result) { 
		...
		function set_Camera(atmid){
			...
			$.ajax({
				...
				success: (function (result) { debugger;
					...
					if(is_agra_site==1){
						var cam1 = url_link+":5026/?name="+uname+"-"+pwd+"-"+dvrip+"-"+port+"-"+dvr_model+"-"+cam_type+"-1";
						var cam2 = url_link+":5027/?name="+uname+"-"+pwd+"-"+dvrip+"-"+port+"-"+dvr_model+"-"+cam_type+"-2";
						var cam3 = url_link+":5028/?name="+uname+"-"+pwd+"-"+dvrip+"-"+port+"-"+dvr_model+"-"+cam_type+"-3";
						var cam4 = url_link+":5029/?name="+uname+"-"+pwd+"-"+dvrip+"-"+port+"-"+dvr_model+"-"+cam_type+"-4";
				  ...
				  console.log(cam1);
				  console.log(cam3);
				 // document.getElementById("#iframe1").src=cam1;
				 // $('#iframe1').attr('src', cam1);
