		...
		th, td {
         ...
         <?php include('top-navbar.php');
			   ...
			   // $month_tbl = 6;
				...
				$newfolder_path = "Footage_Upload"; 	
												
				$newfile_list = ftp_nlist($ftp_conn_local, $newfolder_path);
				//$newfile_list = ftp_nlist($ftp_conn_local, "/Footage_Upload/2024/24Hrs");
				//echo '<pre>';print_r($newfile_list);echo '</pre>';die;
				
				$year_array_data = array();
				...
				if(count($newfile_list)>0){ 
					...
					for($j=0;$j<count($newfile_list);$j++){
						...
						if($split_atm_image[1]!='Test'){
						  array_push($year_array_data, $split_atm_image[1]); 
						}
					}
				}
				
			//	echo '<pre>';print_r($year_array_data);echo '</pre>';die;
                    ...
                    <div class="content-wrapper">
						  ...
						  <div class="card">
						   <!-- <div class="card-body">
							...
							<div class="card-body">
							  <h4 class="card-title">Footage Rejected Details</h4>
							  
							  
								 <div class="row">
								    <?php if(count($year_array_data)>0){ 
									        for($i=0;$i<count($year_array_data);$i++){
									        	$_month_val = $year_array_data[$i];
											  //  array_push($month_array_data, $_month_val);   
									?>
									<div class="col-lg-3 col-xl-2">
										<a href="footage_list_data_rejected_step_1.php?year=<?php echo $_month_val;?>" title="Click ME">  
