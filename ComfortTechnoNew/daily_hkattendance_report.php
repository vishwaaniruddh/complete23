<!DOCTYPE html>
<html lang="en">
    <?php   $page_title = "Daily House Keeping Attendance Report (".date('d-m-Y').")";
	        include('head.php');
                ...
                <div class="main-panel">
                    <div class="content-wrapper">
					    ...
					    <div class="col-12 grid-margin">
                         <h6 class="card-title">Daily House Keeping Attendance Report As on Date : <?php echo date('d/m/Y');?></h6> 
                          <?php include('filters/daily_hkattendance_report_filter.php');?>
						</div> 
                        <!-- Dashboard Wighets -->
...
<!-- Modal starts -->
        ...
        <script src="js/daily_hkattendance_report.js"></script>
