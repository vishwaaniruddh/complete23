                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row" id="share_location" style="display:none;">
                                    ...
                                    <button id="shareLocation" class="btn btn-primary">Share
                                        Location</button>
                                    ...
                                    <button id="copy-location-button" class="btn btn-warning"
                                        onclick="copytodashboard()">Copy Location</button>
                                    <button type="button" class="btn btn-success" id="whatsapp"><i
...
function copytodashboard() {
    ...
    const location = `https://maps.google.com/maps?q=${lat},${lng}&z=15`;
...
document.getElementById('shareLocation').addEventListener('click', () => {
    ...
    // Use the mailto: URL scheme to open the user's default email client
    const emailSubject = 'Site Location Sharing';
    const emailBody = `Check out the Site Locations:  ${shareURL}`;
    const mailtoLink =
        `mailto:?subject=${encodeURIComponent(emailSubject)}&body=${encodeURIComponent(emailBody)}`;

    // Open the user's email client with the location details
