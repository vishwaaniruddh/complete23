            ...
            <div class="container-fluid page-body-wrapper">
                ...
                <div class="main-panel">
                    <div class="content-wrapper">
						  ...
						  <div class="card">
							<div class="card-body">
							  <h4 class="card-title">Footage Rejected Details > <?php echo $month;?> </h4>
								 ...
								 <div class="row">
									...
									<div class="col-lg-3 col-xl-2">
									    <a href="footage_list_atm_details_rejected_tbl_1.php?atmpath=<?php echo $atm_path;?>" title="Click ME">
										<!-- <a href="footage_list_data_rejected_step_3.php?atmpath=" title="Click ME"> -->
