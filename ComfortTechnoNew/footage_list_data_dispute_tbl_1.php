	...
	<style>
							  ...
							  <h4 class="card-title">Footage Dispute Details</h4>
								 ...
								 <div class="row">
									...
									<div class="col-lg-3 col-xl-2">
										<a href="footage_list_date_details_dispute_tbl_1.php?month=<?php echo $_month_val;?>" title="Click ME">  
										...
										<?php if(!in_array($mon,$month_array_data)){ ?>	
                                            <div class="col-lg-3 col-xl-2">
												<a href="footage_list_date_details_dispute_tbl_1.php?month=<?php echo $mon;?>" title="Click ME">  
													<div class="file-man-box">
														<div class="file-img-box">
															<img src="images/shared-folder.png">
														</div>
       ...
       <script>
		 ...
		 function get_Detail(){ 
				...
				$("#load").show();
				$.ajax({
							url: "bulkfootageinsert/footage_start_zip_dispute_first.php", 
							type: "POST",
							success: (function (result) { debugger;
								$("#load").hide(); 
								if(result>0){
									alert("Zip started and it is in process so wait...");
									window.location = "footage_list_data_dispute_tbl.php";
								}else{
