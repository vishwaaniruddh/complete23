...
video { display:none;background-image: url("images/loading.gif");background-repeat: no-repeat;
              ...
              <div class="card">
                <div class="card-body">
                    ...
                    <?php include('filters/sitehealth_filter.php');?>
					       ...
					       <video width="256" height="192"  id="myVideo"  muted autoplay playsinline>
    <source src="test/172.55.24.223_1_1.mp4" id="mp4Source" type="video/mp4">
                                    ...
                                    <div class="sortblock col-md-6 form-group">
										...
										<div class="card form-group">
                                            ...
                                            <div class="card-body" id="camera1" style="height: 300px;padding-top:0px;">
											   <video id="myvideo" width="100%" height="300" muted autoplay playsinline>
											   <source id="mp4LobSource" src="" type="video/mp4">
											   </video>
                                            </div>
                                        </div>
                                    </div>
									   ...
									   <input type="hidden" id="camurl_2">
										...
										<div class="card">
                                            ...
                                            <div class="card-body" id="camera2" style="height: 300px;padding-top:0px;">
											   <video id="myvideo2" width="100%" height="300" muted autoplay playsinline>
											   <source id="mp4LobSource2" src="" type="video/mp4">
											   </video>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="sortblock col-md-6 form-group">
										...
										<div class="card form-group">
                                            ...
                                            <div class="card-body" id="camera3" style="height: 300px;padding-top:0px;">
											    <video id="myvideo3" width="100%" height="300" muted autoplay playsinline>
                                                <source id="mp4LobSource3" src="" type="video/mp4">
												</video>
											</div>
                                        </div>
                                    </div>
									   ...
									   <input type="hidden" id="camurl_4">
										...
										<div class="card">
                                            ...
                                            <div class="card-body" id="camera4" style="height: 300px;padding-top:0px;">
											   <video id="myvideo4" width="100%" height="300" muted autoplay playsinline>
											   <source id="mp4LobSource4" src="" type="video/mp4">
											   </video>
                                            </div>
                                        </div>
                                    </div>
...
<script language="javascript" >
   ...
   function myHandler(e)
   {
      ...
      count++;
      $(mp4Vid).attr('src', v[count]);
      player.load();
      player.play();
   }
   
   vidElem.addEventListener('ended',myLobby,false);
   var mp4LobVid = document.getElementById('mp4LobSource');
   function myLobby(e)
   {
      ...
      activeMyVideo++;
	 // alert(activeMyVideo);
      $(mp4LobVid).attr('src', video_array[activeMyVideo]);
	  vidElem.setAttribute("src", video_array[activeMyVideo]);
      vidElem.load();
      vidElem.play();
   }
	...
	vidElem2.addEventListener('ended',myLobby2,false);
	   var mp4LobVid2 = document.getElementById('mp4LobSource2');
	   function myLobby2(e)
	   {
		  ...
		  activeMyVideo2++;
		  $(mp4LobVid2).attr('src', video_array2[activeMyVideo2]);
		  vidElem2.setAttribute("src", video_array2[activeMyVideo2]);
		  vidElem2.load();
		  vidElem2.play();
	   }
	...
	*/
	...
	vidElem3.addEventListener('ended',myLobby3,false);
	   var mp4LobVid3 = document.getElementById('mp4LobSource3');
	   function myLobby3(e)
	   {
		  ...
		  activeMyVideo3++;
		  $(mp4LobVid3).attr('src', video_array3[activeMyVideo3]);
		  vidElem3.setAttribute("src", video_array3[activeMyVideo3]);
		  vidElem3.load();
		  vidElem3.play();
	   }
	...
	*/
	...
	vidElem4.addEventListener('ended',myLobby4,false);
	   var mp4LobVid4 = document.getElementById('mp4LobSource4');
	   function myLobby4(e)
	   {
		  ...
		  activeMyVideo4++;
		  $(mp4LobVid4).attr('src', video_array4[activeMyVideo4]);
		  vidElem4.setAttribute("src", video_array4[activeMyVideo4]);
		  vidElem4.load();
		  vidElem4.play();
	   }
	  ...
	  //  alert(activeMyVideo); 
		...
		$.ajax({
			...
			success: (function (result) { debugger;
			   ...
			   var objCode = result[0].code;
			   if(objCode==200){
				    // $(mp4LobVid).attr('src', video_array[0]);
				...
				//	$("#camera1_iframe4").html('<iframe src="'+ new_cam4 + '" title="description" style="height: 33vh;width: 100%" scrolling="no"></iframe>');
                   ...
                   for(var i=1;i<=18;i++){ 
					...
					var interval = setInterval(function(){
						if(new Date().getTime() - startTime > 31000){
