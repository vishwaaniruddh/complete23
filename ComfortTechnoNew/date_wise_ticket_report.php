...
<html lang="en">
    <?php   
	        $page_title = "Date Wise Ticket Report (".date('d-m-Y').")";
	        include('head.php');
                ...
                <div class="main-panel">
                    <div class="content-wrapper">
					    ...
					    <div class="col-12 grid-margin">
                         <h6 class="card-title">Date Wise Ticket Report As on Date : <?php echo date('d/m/Y');?></h6> 
                          <?php include('filters/date_wise_ticket_report_filter.php');?>
						</div> 
                        <!-- Dashboard Wighets -->
...
<!-- Modal starts -->
        ...
        <script src="js/date_wise_report.js"></script>
