	...
	<style>
		...
		th, td {
         ...
         <?php include('top-navbar.php');
                ...
                $folder_path = "Footage_Upload/Rejected/".$atmimagepath; 		
                //echo $folder_path;				
            ...
            <div class="container-fluid page-body-wrapper">
                ...
                <div class="main-panel">
                    <div class="content-wrapper">
						  ...
						  <div class="card">
							<div class="card-body">
							  <h4 class="card-title">Footage Rejected Details > <?php echo $split_mon;?> > <?php echo $split_dt;?> > <?php echo $split_atm;?></h4>
