								 ...
								 <div class="row">
								    <?php if(count($file_list)>0){ 
									          for($i=0;$i<count($file_list);$i++){
												  ...
												  $_month_val = $split_month[1];
												  if($_month_val!='Dispute' && $_month_val!='24Hrs' && $_month_val!='Rejected'){
									?>
									<div class="col-lg-3 col-xl-2">
										<a href="footage_list_date_details.php?month=<?php echo $_month_val;?>" title="Click ME">  
