...
$("#show_detail").click(function(){ debugger;
	...
	get_view();
				...
				success: (function (result) { 
				 ...
				 //  $("#load").hide();
				   ...
				   if(dvr_online_count>0){
					   var dvr_online_counthtml = '<a target="_blank" href="networkreport_details.php?client='+Client+'&bank='+Bank+'&circle='+Circle+'&atmid='+AtmID+'&status=1&device=D">'+dvr_online_count+'</a>';
				   ...
				   var dvr_offline_count = obj[0].dvr_offline_count;
				    if(dvr_offline_count>0){
					   var dvr_offline_counthtml = '<a target="_blank" href="networkreport_details.php?client='+Client+'&bank='+Bank+'&circle='+Circle+'&atmid='+AtmID+'&status=0&device=D">'+dvr_offline_count+'</a>';
				   ...
				   if(router_online_count>0){
					   var router_online_counthtml = '<a target="_blank" href="networkreport_details.php?client='+Client+'&bank='+Bank+'&circle='+Circle+'&atmid='+AtmID+'&status=1&device=R">'+router_online_count+'</a>';
				   ...
				   if(router_offline_count>0){
					   var router_offline_counthtml = '<a target="_blank" href="networkreport_details.php?client='+Client+'&bank='+Bank+'&circle='+Circle+'&atmid='+AtmID+'&status=0&device=R">'+router_offline_count+'</a>';
				   ...
				   var panel_online_count = obj[0].panel_online_count;
				    if(panel_online_count>0){
					   var panel_online_counthtml = '<a target="_blank" href="networkreport_details.php?client='+Client+'&bank='+Bank+'&circle='+Circle+'&atmid='+AtmID+'&status=1&device=P">'+panel_online_count+'</a>';
				   ...
				   if(panel_offline_count>0){
					   var panel_offline_counthtml = '<a target="_blank" href="networkreport_details.php?client='+Client+'&bank='+Bank+'&circle='+Circle+'&atmid='+AtmID+'&status=0&device=P">'+panel_offline_count+'</a>';
		...
		function get_view()
		{
			...
			$.ajax({
				url: "networkreport_table_ajax_1_new.php", 
				type: "GET",
				data: {client:Client,bank:Bank,atmid:AtmID,circle:Circle},
				dataType: "html", 
