				  ...
				  // getOnlinePercentMonthWise_Detail();
					   ...
					   if(data.length>0){
						...
						//  tbody += '<tr><td>'+count+'</td><td>'+data[i].atm_id+'</td><td>'+data[i].ip+'</td><td>'+data[i].state+'</td><td>'+data[i].camera_status+'</td><td>'+data[i].site_address+'</td><td>'+data[i].createdatetime+'</td><td>'+src+'</td></tr>';
							 tbody += '<tr><td>'+count+'</td><td>'+data[i].atm_id+'</td><td>'+data[i].lobby_cam+'</td><td>'+data[i].backroom_cam+'</td><td>'+data[i].outdoor_cam+'</td><td>'+data[i].pinhole_cam+'</td><td>'+data[i].last_comm+'</td><td>'+data[i].cdate+'</td><td>'+data[i].capacity+'</td><td>'+data[i].freespace+'</td><td>'+data[i].recording_from+'</td><td>'+data[i].recording_to+'</td></tr>';
							 count++;
						   }
						   tbody += '</tbody>';
						 //  var thead = '<thead><tr><th>S.N</th><th>ATM-ID</th><th>IP</th><th>State</th><th>Camera1</th><th>Address</th><th>Last Communication</th><th>Last File Uploaded</th> </tr></thead>';
						   var thead = '<thead><tr><th>S.N</th><th>ATM-ID</th><th>Lobby Camera</th><th>Backroom Camera</th><th>Outdoor Camera</th><th>Pinhole Camera</th><th>Last Communication</th><th>Current Communication</th><th>Capacity</th><th>Free Space</th><th>Recording From</th><th>Recording To</th> </tr></thead>';
