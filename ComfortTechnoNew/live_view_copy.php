...
<html lang="en">
    <?php 
    include('head_liveView_copy.php');
...
@media (max-width: 480px) {
    ...
    /*screens with a minimum width of 1200px */
              ...
              <div class="card">
                <div class="card-body">
                    ...
                    <?php include('filters/sitehealth_filter.php');?>
					       ...
					       <h6 style="color:red;">Please note: Click Refresh Button manually after watching any site live view <button class="btn btn-primary" id="show_detail"><a href="live_view_copy.php">Refresh</a>	</button></h6> 
