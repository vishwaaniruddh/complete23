...
if($atmid!=''){
	...
	$sql_qry = "select s.Bank,s.ATMID,s.SN,s.SiteAddress,s.DVRIP,s.PanelIP,s.RouterIp,s.ATMID_2,n.device_count
							...
							while($sql_result = mysqli_fetch_assoc($sql)){
								...
								if($_view == 1){
							        ...
							        if($check_network_report_list_cnt==0){
										...
										$insert_sql = "insert into network_report_list (SN,Customer,Bank,ATMID,SiteAddress,router_status,router_ip,router_lastcommunication,router_online_count,router_tot_count,router_online_percent,dvr_status,dvr_ip,dvr_lastcommunication,dvr_online_count,dvr_tot_count,dvr_online_percent,panel_status,panel_ip,panel_lastcommunication,panel_online_count,panel_tot_count,panel_online_percent,created_at,last_action_date)
