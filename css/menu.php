        ...
        <div class="collapse navbar-collapse">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" id="hdm1" style="color:#fff;" data-toggle="dropdown"
              ...
              <div class="dropdown-menu" aria-labelledby="dropdown04">
                ...
                if (in_array("23", $myArray)) { ?>
                  <a id="23" style="" class="dropdown-item" href="viewcustomerDataMaintain.php">View Customer Data
                    Maintain</a>
                <?php } ?>
              </div>
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="services.html" id="hdm2" style="color:#fff;"
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="services.html" id="hdm4" style="color:#fff;"
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="doctors.html" id="hdm3" style="color:#fff;"
                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Alert</a>
            ...
            <li class="nav-item">
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                  <a href="RenewalSite.php" class="dropdown-toggle" data-toggle="dropdown"><span
                      class="label label-pill label-danger count"
                      style="border-radius:10px;"><?php echo $ExpiryCount; ?></span> <span
