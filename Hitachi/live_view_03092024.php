...
<html lang="en">
   ...
   ?>
	...
	<style>
		...
		#camera1 iframe img{ width: 100% !important;height:250px !important;}
		#camera2 iframe img{ width: 100% !important;height:250px !important;}
		#camera3 iframe img{ width: 100% !important;height:250px !important;}
		#camera4 iframe img{ width: 100% !important;height:250px !important;}
...
<h3 class="card-title">Live View</h3>
                ...
                <div class="card-body">
                    ...
                    <?php include('filters/sitehealth_filter.php');?>
					            ...
					            <div class="row">
                                    ...
                                    <div class="sortblock col-md-5 form-group">
										...
										<div class="card form-group">
                                            ...
                                            <div class="card-body" id="camera1" style="height:265px;width:428px;padding-top:0px;">
											     <!--<div class="video-container" id="camera1" style="background: black;max-height:350px;">-->
                                    ...
                                    <div class="sortblock col-md-5 form-group">
										...
										<div class="card">
                                            ...
                                            <div class="card-body" id="camera2" style="height:265px;width:428px;padding-top:0px;">
								...
								<div class="row">
                                    ...
                                    <div class="sortblock col-md-5 form-group">
										...
										<div class="card form-group">
                                            ...
                                            <div class="card-body" id="camera3" style="height:265px;width:428px;padding-top:0px;">
                                    ...
                                    <div class="sortblock col-md-5 form-group">
										...
										<div class="card">
                                            ...
                                            <div class="card-body" id="camera4" style="height:265px;width:428px;padding-top:0px;">
		...
		function startCamera(id){
			...
			$("#camera"+id).html('');
			$("#camera"+id).html('<iframe src="'+ cam + '" title="description" style="height: 265px;width: 384px;display:block;" scrolling="no"></iframe>');
			setStopInterval(id);
		...
		function set_Camera(atmid){
			...
			$.ajax({
				...
				success: (function (result) { debugger;
					...
					if(dvr_model=='CPPLUS_INDIGO' || dvr_model=='CPPLUS'){
						is_rtsp = 1;
					}
					
					if(is_rtsp==1){
						/*
						var cam1 = url_link+":5026/?name="+username+"-"+password+"-"+dvrip+"-"+port+"-"+dvr_model+"-"+cam_type+"-1";
						var cam2 = url_link+":5027/?name="+username+"-"+password+"-"+dvrip+"-"+port+"-"+dvr_model+"-"+cam_type+"-2";
						var cam3 = url_link+":5028/?name="+username+"-"+password+"-"+dvrip+"-"+port+"-"+dvr_model+"-"+cam_type+"-3";
						var cam4 = url_link+":5029/?name="+username+"-"+password+"-"+dvrip+"-"+port+"-"+dvr_model+"-"+cam_type+"-4"; */
						
						var cam1 = url_link+":5040/?name="+username+"-"+password+"-"+dvrip+"-"+port+"-"+dvr_model+"-"+cam_type+"-1";
						var cam2 = url_link+":5041/?name="+username+"-"+password+"-"+dvrip+"-"+port+"-"+dvr_model+"-"+cam_type+"-2";
						var cam3 = url_link+":5042/?name="+username+"-"+password+"-"+dvrip+"-"+port+"-"+dvr_model+"-"+cam_type+"-3";
						var cam4 = url_link+":5043/?name="+username+"-"+password+"-"+dvrip+"-"+port+"-"+dvr_model+"-"+cam_type+"-4";
				...
				//	http://103.141.218.26:5022/?name=admin-admin123-172.55.26.250-554-uniview-nvr-1
				  ...
				  console.log(cam1);
				  $("#camera1").html('<iframe src="'+ cam1 + '" title="description" style="height: 265px;width: 384px;" scrolling="no"></iframe>');
