	...
	<style>
		...
		th, td {
         ...
         <?php include('top-navbar.php');
				...
				$file_list = ftp_nlist($ftp_conn_local, "Footage_Upload/Rejected");
								 ...
								 <div class="row">
								    <?php if(count($file_list)>0){ 
									          for($i=0;$i<count($file_list);$i++){
												  ...
												  $_month_val = $split_month[2];
												  if($_month_val!='Dispute'){
									?>
									<div class="col-lg-3 col-xl-2">
										<a href="footage_list_date_details_rejected_new.php?month=<?php echo $_month_val;?>" title="Click ME">  
