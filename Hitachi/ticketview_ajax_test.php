...
if($portal=="all"){
	...
	b.createtime,b.receivedtime,b.comment,b.zone,b.alarm,b.closedBy,b.closedtime FROM (".$sitesql.") AS a,`alerts` b WHERE a.NewPanelID=b.panelid AND CAST(b.createtime AS DATE)>='".$start."' AND CAST(b.createtime AS DATE)<='".$end."' ORDER BY b.id DESC");					  
}else{
	if($portal=="active"){
	   $sql = mysqli_query($con,"SELECT  a.Customer,a.Bank,a.ATMID,a.ATMShortName,a.SiteAddress,a.DVRIP,a.Panel_make,a.zone as zon,a.City,a.State,b.id,b.panelid,
	b.createtime,b.receivedtime,b.comment,b.zone,b.alarm,b.closedBy,b.closedtime FROM (".$sitesql.") AS a,`alerts` b WHERE a.NewPanelID=b.panelid AND CAST(b.createtime AS DATE)>='".$start."' AND CAST(b.createtime AS DATE)<='".$end."' AND b.status='O' ORDER BY b.id DESC");						  
	}else{
	   $sql = mysqli_query($con,"SELECT  a.Customer,a.Bank,a.ATMID,a.ATMShortName,a.SiteAddress,a.DVRIP,a.Panel_make,a.zone as zon,a.City,a.State,b.id,b.panelid,
	b.createtime,b.receivedtime,b.comment,b.zone,b.alarm,b.closedBy,b.closedtime FROM (".$sitesql.") AS a,`alerts` b WHERE a.NewPanelID=b.panelid AND CAST(b.createtime AS DATE)>='".$start."' AND CAST(b.createtime AS DATE)<='".$end."' AND b.status='C' ORDER BY b.id DESC");					  
	}
}
