                ...
                <div class="main-panel">
                    <div class="content-wrapper">
					    ...
					    <div class="col-12 grid-margin">
                         <h6 class="card-title">PMC FSR Copy Image : <?php echo date('d/m/Y');?></h6> 
                          <?php //include('filters/newnetworkmonthyear_filtertest.php');?>
						</div> 
                        <!-- Dashboard Wighets -->
...
<!-- Modal starts -->
        ...
        <script src="js/view_pmc_fsr_images_report.js"></script>
