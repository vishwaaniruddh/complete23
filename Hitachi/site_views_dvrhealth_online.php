...
if($atmid!=''){
$sql = mysqli_query($con,"select status,atmid,last_communication,ip from dvr_health where atmid='".$atmid."' and login_status='0'"); 
	...
	$onlinetestsql = "SELECT status,atmid,last_communication,ip FROM dvr_health WHERE atmid IN (".$atmidarray.") and login_status='0'";
