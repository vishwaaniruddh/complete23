...
$bank = "PNB"; 
$mon_date = $today;
$sql_qry = "select ATMID,SN,SiteAddress,DVRIP,PanelIP,RouterIp,ATMID_2,ATMID_3,live_date,Zone,State from sites where Customer='" . $client . "' and Bank='" . $bank . "' and live='Y' AND SN NOT IN (SELECT SN from `newnetwork_report` WHERE month_date='".$mon_date."' AND month='".$month."' AND year='".$year."')";
//echo $sql_qry;die;
