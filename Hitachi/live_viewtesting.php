...
<h3 class="card-title">Live View</h3>
					            ...
					            <div class="row">
                                    <div class="sortblock col-md-6 form-group">
										...
										<div class="card form-group">
                                            ...
                                            <div class="card-body">
												 ...
												 <div class="video-container" id="camera1" style="max-height:250px;width:360px;">
                                    ...
                                    <div class="sortblock col-md-6 form-group">
										...
										<div class="card">
                                            ...
                                            <div class="card-body">
											    <div class="video-container" id="camera2" style="background: black;max-height:350px;">
								...
								<div class="row">
                                    <div class="sortblock col-md-6 form-group">
										...
										<div class="card form-group">
                                            ...
                                            <div class="card-body">
											     <div class="video-container" id="camera3" style="background: black;max-height:350px;">
                                    ...
                                    <div class="sortblock col-md-6 form-group">
										...
										<div class="card">
                                            ...
                                            <div class="card-body">
											    <div class="video-container" id="camera4" style="background: black;max-height:350px;">
		...
		function startCamera(id){
			...
			$("#camera"+id).html('');
			$("#camera"+id).html('<iframe src="'+ cam + '" title="description" style="height: 250px;width: 358px;" scrolling="no"></iframe>');
			setStopInterval(id);
		...
		function set_Camera(atmid){
			...
			$.ajax({
				...
				//	http://103.141.218.26:5022/?name=admin-admin123-172.55.26.250-554-uniview-nvr-1
				  ...
				  console.log(cam1);
				  $("#camera1").html('<iframe src="'+ cam1 + '" title="description" style="height: 250px;width: 358px;" scrolling="no"></iframe>');
