<nav class="sidebar sidebar-offcanvas bt" id="sidebar">
                    <ul class="nav">
                       <!-- <li class="nav-item">
						...
						<li class="nav-item">
							...
							<div class="collapse" id="dashboard">
							  <ul class="nav flex-column sub-menu">
								...
								<li class="nav-item"> <a class="nav-link" href="../../panel_dashboard.php">Panel Dashboard</a></li>
								<li class="nav-item"> <a class="nav-link" href="../../dashboard1.php">Dashboard</a></li>
                                <li class="nav-item"> <a class="nav-link" href="../../dvrhealthDashboard.php">DVR Health</a></li>
								<li class="nav-item"> <a class="nav-link" href="../../panel_communication.php">Panel Communication</a></li>
						...
						<li class="nav-item">
							...
							<div class="collapse" id="configuration">
							  <ul class="nav flex-column sub-menu">
								...
								<!-- <li class="nav-item"> <a class="nav-link" href="">Panel Bulk Import</a></li> -->
								<!-- <li class="nav-item"> <a class="nav-link" href="">Import Escalation Matrix</a></li> -->
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="pagination.php">
							    <i class="fa fa-file-video menu-icon">
                                </i>
                                <span class="menu-title">
                                    Video Archive
                                </span>
                               <!-- <img alt="VideoWall" class="menu-icon" src="fonts/menu-icon/videowall.png">
                                    <span class="menu-title">
                                        VideoWall
                                    </span>
                                </img>  -->
                        ...
                        <li class="nav-item">
							...
							<i class="fas fa-images menu-icon">
                               ...
                               <!-- <img alt="Files" class="menu-icon" src="fonts/menu-icon/files.png">
                                    <span class="menu-title">
                                        Files
                                    </span>
                                </img>-->
