...
//s	}
	...
	$fromimage_dir_arr[] = $fromimage_dir;
...
if(count($video_file)>0){
  ...
  //  if(file_exists('download.mp4'))
	...
	$array = array(['Code'=>200,'check'=>$check_dir,'pass' => $pass,'download_link'=>'https://103.141.218.26/ComfortTechnoNew/ffmpeg/bin/download.mp4']);
}
else{
	$array = array(['Code'=>201,'ch'=>$fromimage_dir_arr]);
}
echo json_encode($array);
	
	
	
	//$array = array(['Code'=>$custfrom,'Code1'=>$custto,]);
	//echo json_encode($array);
