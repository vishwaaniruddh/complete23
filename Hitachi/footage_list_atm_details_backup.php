									...
									<div class="col-lg-3 col-xl-2">
                                        ...
                                        <div class="row">										
											<div class="col-md-6 col-xl-6">
											    ...
											    <a class="btn btn-danger" id="<?php echo $_atmid_val;?>" style="display:none;" href="footage-videos.zip" download><i class="fa fa-download"></i></a>
											</div>
                                        </div>										
									</div>
												  <?php }}}?>
