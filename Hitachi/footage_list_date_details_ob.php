	...
	<style>
		...
		th, td {
         ...
         <?php include('top-navbar.php');
				...
				$month = $_GET['month'];	
                $folder_path = "All_Footages/".$month; 				
            ...
            <div class="container-fluid page-body-wrapper">
                ...
                <div class="main-panel">
                    <div class="content-wrapper">
						  ...
						  <div class="card">
							<div class="card-body">
							  <h4 class="card-title">Footage Details > <?php echo $month;?></h4>
								 ...
								 <div class="row">
								    <?php if(count($file_list)>0){ 
									          for($i=0;$i<count($file_list);$i++){
												  ...
												  if(count($split_atm)==3){
												     $_atmid_val = $split_atm[2];
													 $month_atm = $month."/".$_atmid_val;
									?>
									<div class="col-lg-3 col-xl-2">
										<a href="footage_list_atm_details_ob.php?atmpath=<?php echo $month_atm;?>" title="Click ME">  
