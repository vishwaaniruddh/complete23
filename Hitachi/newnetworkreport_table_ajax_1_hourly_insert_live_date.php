...
$bank = "PNB"; 
$sql_qry = "select ATMID,SN,SiteAddress,DVRIP,PanelIP,RouterIp,ATMID_2,ATMID_3,live_date,Zone,State,live_date from sites where Customer='" . $client . "' and Bank='" . $bank . "' and live='Y'";
