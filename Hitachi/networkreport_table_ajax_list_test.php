...
if($atmid!=''){
	...
	if($bank!=''){
		if($circle!=''){
			...
			if($device=='R'){
				$sql = mysqli_query($con,"select * from network_report_list where Customer='".$client."' and Bank='".$bank."' and live='Y' AND router_status='".$status."'");
			}
			if($device=='D'){
				//$_se = "select * from network_report_list where ATMID IN (".$circleatmidarray.") AND dvr_status='".$status."'";
				$sql = mysqli_query($con,"select * from network_report_list where Customer='".$client."' and Bank='".$bank."' and live='Y' AND dvr_status='".$status."'");
			}
			if($device=='P'){
				$sql = mysqli_query($con,"select * from network_report_list where Customer='".$client."' and Bank='".$bank."' and live='Y' AND panel_status='".$status."'");
			}
		...
		if($client=='All'){
			...
			if($device=='D'){
				//$_se = "select * from network_report_list where ATMID IN (".$circleatmidarray.") AND dvr_status='".$status."'";
				$sql = mysqli_query($con,"select * from network_report_list where live='Y' AND dvr_status='".$status."'");
			}
			if($device=='P'){
				$sql = mysqli_query($con,"select * from network_report_list where live='Y' AND panel_status='".$status."'");
			}
		   //$circlesql = mysqli_query($con,"select ATMID from sites where live='Y'");	
		}else{
			
			if($device=='R'){
				$sql = mysqli_query($con,"select * from network_report_list where Customer='".$client."' AND Bank IN (".$_bank_name.") AND live='Y' AND router_status='".$status."'");
			}
			if($device=='D'){
				//$_se = "select * from network_report_list where ATMID IN (".$circleatmidarray.") AND dvr_status='".$status."'";
				$sql = mysqli_query($con,"select * from network_report_list where Customer='".$client."' AND Bank IN (".$_bank_name.") AND live='Y' AND dvr_status='".$status."'");
			}
			if($device=='P'){
				$sql = mysqli_query($con,"select * from network_report_list where Customer='".$client."' AND Bank IN (".$_bank_name.") AND live='Y' AND panel_status='".$status."'");
			}
