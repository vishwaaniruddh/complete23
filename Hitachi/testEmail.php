...
//$mail->Password = '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';
$mail->SMTPSecure = 'tls';                  // Enable TLS encryption, `ssl` also accepted
$mail->Port = 587;                          // TCP port to connect to
//$mail->setFrom('prabirdutta@sarmicrosystems.in', 'Test');
$mail->setFrom('rms@comforttechno.com', 'Test');
