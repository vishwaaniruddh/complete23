...
$_downsites_array = ['3284','3334','3533','3378','3510','3518','3639','3844','3865','3950','3989','4029','4112','4200','4219','4549','10060','4538','4635','4764','4968','5051','5081','10125','5636','5204','6255', '3658','3159','3306','3417','3500','3536','3538','3573','3625','3651','3662','3694','3756','3832','3834','3888','3902','3970','4304','4347','4483','4611','4656','4671','4688','4724','4728','4916','4960','5036','5114','5176','5222','5255','5355','5375','5382','5414','5417','5419','5942','5863','5881','5584','5654','5595','5609','5555'];
...
$bank = "PNB"; 
//$sql_qry = "select ATMID,SN,SiteAddress,DVRIP,PanelIP,RouterIp,ATMID_2,ATMID_3,live_date,Zone,State from sites where Customer='" . $client . "' and Bank='" . $bank . "' and live='Y' AND SN IN (SELECT SN from `newnetwork_report` WHERE month_date='".$mon_date."' AND month='".$month."' AND year='".$year."' AND today_tot_hit < '".$nowtime_hour."') limit 1000";
//$sql_qry = "select ATMID,SN,SiteAddress,DVRIP,PanelIP,RouterIp,ATMID_2,ATMID_3,live_date,Zone,State from sites where Customer='Hitachi' and Bank='PNB' and live='Y' AND SN IN (SELECT SN from `newnetwork_report` WHERE month_date='2023-06-01' AND month='6' AND year='2023') limit 0,250";
$sql_qry = "select SN from sites where Customer='" . $client . "' and Bank='" . $bank . "' and live='Y' AND SN IN (SELECT SN from `newnetwork_report` WHERE downtime=15) ";
	...
	while($sql_result = mysqli_fetch_assoc($sql)){
		...
		$_view = 1;
			...
			if($_view == 1){
				...
				//echo $SN."_";
				//echo 'uptime : '.$total_uptime."_ Downtime".$total_downtime;die;
				/*
