					...
					<?php 
                            ...
                            if(isset($_POST['submit'])){
									...
									//$updated_at = date('Y-m-d');
								                if($err==0){
													$statement = " INSERT INTO `multiple_footage_download_test`( `ip`, `cam_no`, `from_datetime`, `to_datetime`, `pc_no`, `status`, `created_by`) VALUES ('".$ip."','".$camno."','".$from."','".$to."','".$pcno."','".$status."','".$created_by."') ";
													//echo $statement;die;
