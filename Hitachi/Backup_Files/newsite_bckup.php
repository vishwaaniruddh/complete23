...
?>
											  ...
											  <div class="col-md-4">
												<div class="form-group row">
												  ...
												  <div class="col-sm-9">
													<input type="text" class="form-control" name="NewPanelID" id="NewPanelID" value=""/>
												  </div>
												</div>
											  </div>
											</div>
											...
											<div class="row">
											  ...
											  <div class="col-md-4">
												<div class="form-group row">
												  ...
												  <div class="col-sm-9">
													<input type="text" class="form-control" name="DVR_Model_num" id="DVR_Model_num">
												  </div>
												</div>
											  </div>
											  ...
											  <div class="col-md-4">
												<div class="form-group row">
												  ...
												  <div class="col-sm-9">
													<input type="text" class="form-control" name="Router_Model_num" id="Router_Model_num">
												  </div>
												</div>
											  </div>
											  <div class="col-md-4">
