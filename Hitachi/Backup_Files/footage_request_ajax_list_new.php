                      ...
                      <tbody>
                        ...
                        ?>
							   <tr>
									...
									<td><?php if(count($file_url)>0){ for($f=0;$f<count($file_url);$f++){ 
									echo '<a href="ffmpeg/bin/'.$file_url[$f]['url'].'" target="_blank">'.$file_url[$f]['name'].'</a></br>';}}?></td>
									...
									<td><?php if($footage_avail=='No'){  ?>
									<a class="btn btn-info" href="footage_request_edit.php?id=<?php echo $_id;?>">Process</a>
									<?php }?>
									</td>
								   <!-- <td>
