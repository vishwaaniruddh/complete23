...
<h3 class="card-title">Live View</h3>
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="form-sample">
                    ...
                    <!--<a href="" class="btn btn-primary" id="Button">Show</a>
					            ...
					            <div class="row">
                                    <div class="sortblock col-md-12 form-group">
										...
										<div class="card form-group">
                                            ...
                                            <div class="card-body">
											     <div class="video-container" id="camera1" style="background: black;max-height:50vh;">
		...
		function startCamera(id){
			...
			$("#camera"+id).html('');
			$("#camera"+id).html('<iframe src="'+ cam + '" title="description" style="height: 50vh;width: 100%;"></iframe>');
			setStopInterval(id);
		...
		function set_Camera(atmid){
			...
			$.ajax({
				...
				//	http://103.141.218.26:5022/?name=admin-admin123-172.55.26.250-554-uniview-nvr-1
				    var cam1 = "http://103.141.218.26:5022/?name="+username+"-"+password+"-"+ip+"-"+port+"-"+dvr_model+"-"+cam_type+"-1";
					var cam2 = "http://103.141.218.26:5022/?name="+username+"-"+password+"-"+ip+"-"+port+"-"+dvr_model+"-"+cam_type+"-2";
					var cam3 = "http://103.141.218.26:5022/?name="+username+"-"+password+"-"+ip+"-"+port+"-"+dvr_model+"-"+cam_type+"-3";
					var cam4 = "http://103.141.218.26:5022/?name="+username+"-"+password+"-"+ip+"-"+port+"-"+dvr_model+"-"+cam_type+"-4";
				  $("#camera1").html('<iframe src="'+ cam1 + '" title="description" style="height: 50vh;width: 100%;"></iframe>');
