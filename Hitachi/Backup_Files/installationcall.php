<!DOCTYPE html>
			...
			white-space: nowrap;
                    ...
                    <h3 class="card-title">Installation Call</h3>

                    <?php include("filters/installationcall_filter.php");?>
                    <div class="card">
                    <div class="card-body">
			    ...
			    <div class="col-md-6">
			     <div id="reportrange" class="form-control"   data-cancel-class="btn-light"  style="float:right;">
                    ...
                    <div class="row">
                    <div class="col-12" id="installationcall_tbody">
...
<script>
            ...
            cb(start, end);
                    ...
                    <script src="js/installationcall.js">
                    </script>
