          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-12">
                  <div class="table-responsive">
                    <table id="order-listing" class="table">
                      ...
                      ?>
                            <tr>
                                <!-- <td><button type="submit" name="sub" onclick="window.location.href='updatesite.php';" value="submit" class="btn btn-primary mr-2" style="float:right"> Edit</button></td> -->
                ...
                <!-- <button type="submit" name="sub" onclick="window.location.href='updatesite.php';" value="submit" class="btn btn-primary mr-2" style="float:right"> Edit</button> -->
