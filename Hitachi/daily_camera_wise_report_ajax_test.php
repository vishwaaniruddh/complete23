								...
								if($_view == 1){
									...
									?>
									   <tr>
										   ...
										   <td rowspan="4"><?php echo $atm_id;?></td>
										   <td rowspan="4"><?php echo $_circleName;?></td>
										   <td rowspan="4"><?php echo $_Zone;?></td>
										   <td rowspan="4"><?php echo $sql_result['State'];?></td>
										   <td rowspan="4"><?php echo $site_address;?></td>
										   <td rowspan="4"><?php echo '-';?></td>
										   <td>Lobby Camera</td>
										   <?php for($i=0;$i<count($_dt_range);$i++){ ?>
						                   <td><?php echo '0';?></td>
										   <?php }?>
