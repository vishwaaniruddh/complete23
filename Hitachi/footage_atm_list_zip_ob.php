...
if(isset($_POST['atmid'])){
		...
		$ftp_pasv_local = ftp_pasv($ftp_conn_local,true);
         ...
         $newfolder_path = "All_Footages/".$atmimagepath; 		
        ...
        if(count($imagesdata_array)>0){
           ...
           /* $result = create_zip($files_to_zip,$fileName);
			...
			// Get real path for our folder
				...
				$code = 200;	
                $created_by = 24;
                $set_sql = "INSERT INTO `footage_all_details_available`( `month`, `dt`,`atmid`, `created_at`, `updated_at`, `created_by`) VALUES ('".$fol_mon."','".$fol_dt."','".$atm_val."','".$current_datetime."','".$current_datetime."','".$created_by."') ";
