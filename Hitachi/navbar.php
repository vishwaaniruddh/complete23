						...
						<li class="nav-item">
							...
							<div class="collapse" id="<?php echo $main_name; ?>">
							  <ul class="nav flex-column sub-menu">
								...
								<li class="nav-item"> <a class="nav-link" href="https://comfort.ifiber.in:8080/Hitachi/live_view.php"><?php echo $submenu_name; ?></a></li>	
								<?php }else{ ?>	
								   <?php
								      if($page=="viewlive.php"){ ?>
								   <li class="nav-item"> <a class="nav-link" href="https://comfort.ifiber.in:8080/Hitachi/viewlive.php"><?php echo $submenu_name; ?></a></li>
									  <?php }else{ ?>
								...
								<!-- <li class="nav-item"> <a class="nav-link" href="<?php // echo $page; ?>"><?php // echo $submenu_name; ?></a></li> -->
								 ...
								 <?php if($page=="live_view_fss.php"){ ?>
								   <li class="nav-item"> <a class="nav-link" href="https://comfort.ifiber.in:8080/Hitachi/live_view_fss.php"><?php echo $submenu_name; ?></a></li>
									  <?php }else{ ?>
								    <li class="nav-item"> <a class="nav-link" href="<?php echo $page; ?>"><?php echo $submenu_name; ?></a></li>
								<?php } } ?>
									<?php } } }?>
