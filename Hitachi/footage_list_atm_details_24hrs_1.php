...
.tooltip:hover .tooltiptext {
  visibility: visible;
         ...
         <?php include('top-navbar.php');
				...
				$getimagesql = "SELECT * FROM `footage_details_available` WHERE month='".$mon."' AND dt='".$dt."' AND footage_type='24Hrs'"; 
				//echo $getimagesql;
                ...
                $folder_path = "Footage_Upload/24Hrs/".$atmpath."/N1976800  14-06-2023  11.50 TO 12.20"; 		
               // $folder_path = "Footage_Upload/24Hrs/".$atmpath;  				
