...
$ftpmonth_array = ["JAN","FEB","MAR","APR","MAY","JUN","JUL","AUG","SEPT","OCT","NOV","DEC"];
...
function create_zip($files = array(),$destination = '',$overwrite = false) {
	 ...
	 */	
       // $fileName = $atm_val.'.zip';
		...
		$ftp_conn_local = OpenComfortFTPLocalConCheck();
		$ftp_pasv_local = ftp_pasv($ftp_conn_local,true);
		
		$footage_type = "Rejected";
		
        $newfolder_path = $ftp_root_fol."/Footage_Upload/Rejected/".$mon."/".$dt; 	
